// client/src/App.jsx
// FIXES:
// 1. PatientLayout / StaffLayout / DoctorLayout / AdminLayout now wrapped in their guards
//    so the layout itself can't render without auth — prevents flicker on reload.
// 2. Catch-all 404 → redirect to /.
// 3. All route paths match their sidebar NavLink paths exactly.
...
const router = createBrowserRouter(createRoutesFromElements(
  <>
    <Route path='/' element={<Layout />}>
      ...
      {/* ── Patient protected ───────────────────────── */}
      {/* FIX: wrap PatientLayout in PatientRoute so auth is enforced at the layout level */}
