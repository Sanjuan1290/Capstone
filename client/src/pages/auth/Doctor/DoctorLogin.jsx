    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-bold text-slate-800 tracking-tight">Doctor Portal</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2.5 bg-slate-50 border-2 border-slate-200 rounded-xl
                px-3 py-2.5 focus-within:border-violet-400 transition-colors">
                <MdEmail className="text-slate-400 text-[16px] shrink-0" />
                <input type="email" name="email" value={form.email} onChange={handleChange}
                  placeholder="doctor@email.com" required autoComplete="email"
