...
import { 
  MdEmail, MdLock, MdVisibility, MdVisibilityOff, MdAdminPanelSettings 
} from "react-icons/md"
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm px-7 py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full mt-2 bg-[#0b1a2c] hover:bg-[#122236] disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-bold py-3 rounded-xl transition-colors shadow-sm active:scale-[0.98]"
            >
