...
import {
  ...
  MdLocationOn, MdCheckCircle, MdSchedule
} from "react-icons/md"
...
const MyAppointments = () => {
  ...
  const handleCancel = async (appointmentId) => {
    ...
    try {
      ...
      // Close modal if the cancelled appointment was open
  ...
  if (loadingData) return <div className="p-10 text-center text-slate-500">Loading appointments...</div>
