    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-[72px] z-10 w-6 h-6 rounded-full bg-[#0b1a2c] border border-white/10
            flex items-center justify-center text-slate-400 hover:text-white shadow-md
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <header className="h-16 bg-white border-b border-slate-100 flex items-center justify-between px-6 shrink-0">
          <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 w-64
            text-sm text-slate-400 hover:border-slate-300 transition-colors cursor-text select-none">
