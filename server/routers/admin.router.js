...
router.post('/billing/payments/:paymentId/void', ...auth, otpRequestLimiter, adminCtrl.voidBillingPayment)
router.post('/billing/payments/:paymentId/refund', ...auth, otpRequestLimiter, adminCtrl.refundBillingPayment)
router.post('/billing/payments/:paymentId/action/confirm', ...auth, otpVerifyLimiter, adminCtrl.confirmBillingPaymentAction)
...
router.get('/audit-logs/archive', ...auth, adminCtrl.getAuditArchiveBatches)
router.post('/audit-logs/archive', ...auth, adminCtrl.archiveAuditLogs)
...
router.get('/inventory/locations',     ...auth, adminCtrl.getInventoryLocationsAdmin)
router.put('/inventory/locations/:id', ...auth, adminCtrl.updateInventoryLocation)
router.delete('/inventory/locations/:id', ...auth, adminCtrl.deleteInventoryLocation)
