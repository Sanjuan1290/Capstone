...
CREATE TABLE `audit_logs` (
  ...
  KEY `idx_audit_user` (`user_role`,`user_id`,`created_at`)
...
CREATE TABLE `billing_payments` (
  ...
  `voided_by_staff_id` int DEFAULT NULL,
  `void_reason` text,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_billing_payment_receipt` (`receipt_number`),
  KEY `idx_billing_payments_bill` (`billing_id`,`paid_at`),
  KEY `fk_billing_payments_received_staff` (`received_by_staff_id`),
  KEY `fk_billing_payments_voided_staff` (`voided_by_staff_id`),
  CONSTRAINT `fk_billing_payments_bill` FOREIGN KEY (`billing_id`) REFERENCES `billing_records` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_billing_payments_received_staff` FOREIGN KEY (`received_by_staff_id`) REFERENCES `staff` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_billing_payments_voided_staff` FOREIGN KEY (`voided_by_staff_id`) REFERENCES `staff` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `clinic_payment_settings`
--

DROP TABLE IF EXISTS `clinic_payment_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `clinic_payment_settings` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_clinic_payment_settings_admin` (`updated_by_admin_id`),
  CONSTRAINT `fk_clinic_payment_settings_admin` FOREIGN KEY (`updated_by_admin_id`) REFERENCES `admins` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `clinic_payment_settings`
--

LOCK TABLES `clinic_payment_settings` WRITE;
/*!40000 ALTER TABLE `clinic_payment_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `clinic_payment_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-07-21 13:17:37